...
class StartVoiceBroadcastUseCase @Inject constructor(
    ...
    suspend fun execute(roomId: String) {
        ...
        Timber.d("Start voice broadcast requested")
        ...
        if (lastVoiceBroadcastState != null && lastVoiceBroadcastState != VoiceBroadcastState.STOPPED) {
            Timber.d("Cannot start voice broadcast, there is already a started one")
